...
// Для показа нужно выбрать баннер с максимальным weight
...
// 3)
// Для баннера A: weight = 0 + sqrt(2 * ln(2) / 1) =  1,18;
// Для баннера B: weight = 0 + sqrt(2 * ln(2) / 1) =  1,18;
//  Выбираем показать A, 2 показа, 0 переходов
// 4)
// Для баннера A: weight = 0 + sqrt(2 * ln(3) / 2) =  0,74;
// Для баннера B: weight = 0 + sqrt(2 * ln(3) / 1) =  1,48;
...
// 3)
// Для баннера A: weight = 0 + sqrt(2 * ln(2) / 1) =  1,18;
// Для баннера B: weight = 1 + sqrt(2 * ln(2) / 1) =  2,18;
//  Выбираем показать B, 2 показа, 2 переходов
// 4)
// Для баннера A: weight = 0 + sqrt(2 * ln(3) / 1) =  1,48;
// Для баннера B: weight = 1 + sqrt(2 * ln(3) / 2) =  1,74;
//  Выбираем показать B, 3 показа, 3 переходов
// 5)
// Для баннера A: weight = 0 + sqrt(2 * ln(4) / 1) =  1,67;
// Для баннера B: weight = 1 + sqrt(2 * ln(4) / 3) =  1,55;
//  Выбираем показать A, 2 показа, 0 переходов
// 6)
// Для баннера A: weight = 0 + sqrt(2 * ln(5) / 2) =  0,89;
// Для баннера B: weight = 1 + sqrt(2 * ln(5) / 3) =  1,59;
//  Выбираем показать B, 4 показа, 4 переходов
// 7)
// Для баннера A: weight = 0 + sqrt(2 * ln(6) / 2) =  0,94;
// Для баннера B: weight = 1 + sqrt(2 * ln(6) / 4) =  1,47;
//  Выбираем показать B, 5 показа, 5 переходов
// 8)
// Для баннера A: weight = 0 + sqrt(2 * ln(7) / 2) =  0,98;
// Для баннера B: weight = 1 + sqrt(2 * ln(7) / 5) =  1,39;
//  Выбираем показать B, 4 показа, 4 переходов
